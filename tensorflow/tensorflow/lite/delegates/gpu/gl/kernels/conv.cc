...
class Convolution : public NodeShader {
 public:
  Status GenerateCode(const GenerationContext& ctx,
    ...
    //ADD DUMPING CODE HERE 
    // std::ofstream outfile;
    // outfile.open("dump_code.c", std::ios::app);
    // outfile << "\n\n\nCalling Convolution_GenerateCode!\n" << std::endl;
    // outfile << source << std::endl;
    // outfile << "Convolution_GenerateCode finished!\n\n\n" << std::endl;
    // outfile.close();
 ...
 public:
  Status GenerateCode(const GenerationContext& ctx,
    ...
    *generated_code = {
    ...
    // std::ofstream outfile;
    // outfile.open("dump_code.c", std::ios::app);
    // outfile << "\n\n\nCalling Convolution1x1_GenerateCode!\n" << std::endl;
    // outfile << source << std::endl;
    // outfile << "Convolution1x1_GenerateCode finished!\n\n\n" << std::endl;
    // outfile.close();
    // std::cout << "source1x1:" << std::endl;
    // std::cout << source << std::endl;
    return OkStatus();
  }
};
